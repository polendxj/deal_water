            ...
            <div>
                <div style={{width: "203px", paddingLeft: "45px"}}>
                    <div className="form-group has-feedback has-feedback-left"
                        ...
                        <input type="text" className="form-control input-xs" placeholder="搜索待处理巡检河道"
                ...
                <fieldset className="content-group" style={{padding: "30px"}}>
                    <legend style={{fontSize: "14px", color: "#5E6166", border: "0 red solid"}}>待处理巡检河道列表</legend>
            ...
            <div>
                ...
                <div className="tabbable">
                    <ul className="nav nav-tabs nav-tabs-bottom">
                        ...
                        <li onClick={this._getStatics.bind(this)}><a style={{fontSize: "16px"}} href="#bottom-tab2" data-toggle="tab">历史巡检分析</a></li>
                                    ...
                                    <fieldset className="content-group" style={{padding: "10px"}}>
                                        <legend style={{fontSize: "16px", color: "#5E6166"}}>
                                            ...
                                            <span className="pull-right"
                                                  style={{fontSize: "12px", color: "gray", marginTop: "3px",cursor:"pointer"}}> 进入治理条目</span>
                                        </legend>
                                        <p>对河道进行侦查、数据分析后进行人员安排到该地进行河道治理，需修改治理状态。</p>
                                        <div className="table-responsive">
                                            <table className="table" style={{fontSize: "14px"}}>
                                                <tbody>
                                                <tr>
                                                    <td style={{width: "200px", borderTop: "0 red solid"}}>状态</td>
                                                    <td style={{borderTop: "0 red solid", color: "red"}}>已审核，但未开始治理</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="table-responsive">
                                                <table className="table" style={{fontSize: "14px"}}>
                                                    ...
                                                    <tr>
                                                        <td style={{width:"50px",borderTop: "0 red solid"}}><i className="icon-circle-small"></i></td>
                                                        <td style={{borderTop: "0 red solid"}}>王自健</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <legend style={{fontSize: "16px", color: "#5E6166"}}>
                                            ...
                                            <span className="pull-right"
                                                ...
                                                className=" icon-more"></i> 更多巡检记录</span>
                                        </legend>
                                        <div className="table-responsive">
                                            <table className="table" style={{fontSize: "14px"}}>
                                                <tbody>
